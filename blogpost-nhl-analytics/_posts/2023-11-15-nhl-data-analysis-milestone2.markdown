...
<!-- {% include image_full.html imageurl="/images/milestone2/.png" caption="setting up the environment" %} -->
...
[Link](https://www.comet.com/nhl-analytics-milestone-2/feature-engineering-data/519fe224df9c448d9a35a4586141fd96?experiment-tab=panels&showOutliers=true&smoothing=0&xAxis=step) to the experiment which stores the filtered DataFrame artifact
...
1. Random Forest Classifier
   ...
   With this method, we kept the following features:
      - TimeLastEvent
      - Speed
      - DistanceLastEvent
      - LastEvent_XCoord
...
2. Correlation Matrix
   ...
   With this method, we included only the following features:
      - Speed
      - DistanceLastEvent
      - LastEvent
      - DistanceToGoal
...
We have come to the conclusion that the neural network trained with the features selected by the random forest classifier had the best results overall. Actually, all these models had very similar results, however this one had the best reliability curve.


#### CONCLUSION:

For this part, we have attempted many different things to get the best model possible. We tried different types of models, different feature selection methods, shuffled the data and tuned the hyperparameters of our models. We have come to the conclusion that the best model was _________ because ________.
